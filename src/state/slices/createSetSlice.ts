...
export const createSetSlice = createSlice({
    ...
    reducers: {
        setAdvancedSectionProps: (
            state,
            action: PayloadAction<AdvancedSectionProps>
        ) => {
...
export const { setAdvancedSectionProps } = createSetSlice.actions;

/* Selectors */
export const selectAdvancedSectionProps = (state): AdvancedSectionProps =>
    state[sliceName].advancedSectionProps;
