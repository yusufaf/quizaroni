    ...
    <AccountViewContainer>
      <ActionColumn>
        ...
        <SimpleFlexContainer style={{ gap: "1rem" }}>
          ...
          >
            <ToggleButton value={LIGHT} title={t("profile.switchToLight")}>
              <LightMode />
            </ToggleButton>
            <ToggleButton value={DARK} title={t("profile.switchToDark")}>
              <DarkMode />
            </ToggleButton>
          </ToggleButtonGroup>
      ...
      <ActionColumn>
        <ActionHeader>
          <RecordVoiceOver />
          <Typography variant="h6">{t("profile.ttsVoice")}</Typography>
        </ActionHeader>
        <SimpleFlexContainer style={{ gap: "1rem" }}>
          <SimpleSelect
            value={ttsVoice}
          ...
          >
            <MenuItem value="">{t("profile.defaultTtsVoice")}</MenuItem>
            {voices.map((voice) => (
